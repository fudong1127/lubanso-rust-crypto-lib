...
use lubanso_bitcoin::bip32::{ExtendedPrivKey, ExtendedPubKey, Fingerprint, IntoDerivationPath, KeySource};
use lubanso_bitcoin::blockdata::opcodes::OP_0;
use lubanso_bitcoin::blockdata::script;
use lubanso_bitcoin::consensus::encode::{deserialize, serialize_hex};
use lubanso_bitcoin::hashes::hex::FromHex;
use lubanso_bitcoin::psbt::{Psbt, PsbtSighashType};
use lubanso_bitcoin::script::PushBytes;
use lubanso_bitcoin::secp256k1::{self, Secp256k1};
use lubanso_bitcoin::{
...
fn signer_one_sign(psbt: Psbt, key_map: BTreeMap<lubanso_bitcoin::PublicKey, PrivateKey>) -> Psbt {
...
fn signer_two_sign(psbt: Psbt, key_map: BTreeMap<lubanso_bitcoin::PublicKey, PrivateKey>) -> Psbt {
...
fn sign(mut psbt: Psbt, keys: BTreeMap<lubanso_bitcoin::PublicKey, PrivateKey>) -> Psbt {
    let secp = Secp256k1::new();
