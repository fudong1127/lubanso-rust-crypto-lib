...
FEATURES="lubanso-hashes global-context lowmemory rand recovery serde std alloc lubanso-hashes-std rand-std"
...
if [ "$DO_FEATURE_MATRIX" = true ]; then
    ...
    # Examples
    cargo run --example sign_verify --features=lubanso-hashes-std
    cargo run --example sign_verify_recovery --features=recovery,lubanso-hashes-std
