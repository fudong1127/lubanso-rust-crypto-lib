...
macro_rules! impl_display_secret {
    ...
    ($thing:ident) => {
        ...
        #[cfg(all(not(feature = "std"), feature = "lubanso-hashes"))]
        impl ::core::fmt::Debug for $thing {
            fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ...
        #[cfg(all(not(feature = "std"), not(feature = "lubanso-hashes")))]
        impl ::core::fmt::Debug for $thing {
            fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
                write!(f, "<secret requires std or lubanso-hashes feature to display>")
            }
        }
    };
}
